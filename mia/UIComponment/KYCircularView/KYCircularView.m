...
#define ColorFromHex(rgbValue) [UIColor colorWithRed:((float)((rgbValue & 0xFF0000) >> 16))/255.0 green:((float)((rgbValue & 0xFF00) >> 8))/255.0 blue:((float)(rgbValue & 0xFF))/255.0 alpha:0.55]
...
- (void)setup {
    ...
    if (self.colors == nil) {
        _gradientLayer.colors = @[(__bridge id)ColorFromHex(0x9ACDE7).CGColor, (__bridge id)ColorFromHex(0xE7A5C9).CGColor];
    } else {
