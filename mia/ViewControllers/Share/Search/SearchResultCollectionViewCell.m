...
//	contentView.backgroundColor = arc4random() %2 == 0 ? [UIColor redColor] : [UIColor greenColor];
    ...
    _coverImageView.backgroundColor = UIColorByHex(0xf1f5f5);
	...
	_playButton = [[MIAButton alloc] initWithFrame:CGRectZero
									   titleString:nil
										titleColor:nil
										   ...
										   logoImg:nil
								   backgroundImage:nil];
	[_playButton setBackgroundImage:[UIImage imageNamed:@"CM-PlayIcon"] forState:UIControlStateNormal];
...
- (void)setIsPlaying:(BOOL)isPlaying {
	...
	if (isPlaying) {
		[_playButton setBackgroundImage:[UIImage imageNamed:@"CM-PauseIcon"] forState:UIControlStateNormal];
	} else {
		[_playButton setBackgroundImage:[UIImage imageNamed:@"CM-PlayIcon"] forState:UIControlStateNormal];
	}
}
