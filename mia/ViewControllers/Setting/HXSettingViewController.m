...
typedef NS_ENUM(NSUInteger, HXSettingSection) {
    ...
    HXSettingSectionData,
    HXSettingSectionInfo,
    HXSettingSectionLogout
};

typedef NS_ENUM(NSUInteger, HXSettingUserSectionRow) {
    HXSettingUserSectionRowAvatar,
    HXSettingUserSectionRowNickName,
    HXSettingUserSectionRowGender,
    HXSettingUserSectionRowPassWord
};

typedef NS_ENUM(NSUInteger, HXSettingDataSectionRow) {
    HXSettingDataSectionRowNetworking,
    HXSettingDataSectionRowCache
};

typedef NS_ENUM(NSUInteger, HXSettingInfoSectionRow) {
    HXSettingInfoSectionRowFeedBack,
    HXSettingInfoSectionRowVersion
};

@interface HXSettingViewController () <UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITextFieldDelegate, GenderPickerViewDelegate>
@end
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {\
    ...
    switch (section) {
        case HXSettingSectionUser: {
            HXSettingUserSectionRow row = indexPath.row;
            switch (row) {
                case HXSettingUserSectionRowAvatar: {
                    [self avatarTouchAction];
                    break;
                }
                case HXSettingUserSectionRowNickName: {
                    [self nickNameTouchAction];
                    break;
                }
                case HXSettingUserSectionRowGender: {
                    [self genderTouchAction];
                    break;
                }
                case HXSettingUserSectionRowPassWord: {
        ...
        case HXSettingSectionData: {
            HXSettingDataSectionRow row = indexPath.row;
            switch (row) {
                case HXSettingDataSectionRowNetworking: {
                    break;
                }
                case HXSettingDataSectionRowCache: {
        ...
        case HXSettingSectionInfo: {
            HXSettingInfoSectionRow row = indexPath.row;
            switch (row) {
                case HXSettingInfoSectionRowFeedBack: {
                    [self feedbackTouchAction];
                    break;
                }
                case HXSettingInfoSectionRowVersion: {
