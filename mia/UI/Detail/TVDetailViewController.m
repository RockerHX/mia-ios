...
@interface TVDetailViewController () <UIActionSheetDelegate>

@end

@implementation TVDetailViewController {
	UIScrollView *scrollView;
	DetailHeaderView *playerView;
...
- (void)initUI {
	...
	playerView = [[DetailHeaderView alloc] initWithFrame:CGRectMake(0, kPlayerMarginTop, scrollView.frame.size.width, kPlayerHeight)];
